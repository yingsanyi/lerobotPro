...
3. Prefer raw CAN sniffing and traffic-based interface detection for bring-up.
...
5. Sniff and analyze protocol frames before touching motor adapter logic.
...
4. Sniffed frames show stable traffic and expected CAN 2.0 flags (`is_fd=0` if classic CAN).
